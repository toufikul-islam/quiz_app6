...
class StudentCategorySelectionScreen extends StatefulWidget {
  final Student student;

  const StudentCategorySelectionScreen({super.key, required this.student});

  @override
  State<StudentCategorySelectionScreen> createState() =>
      _StudentCategorySelectionScreenState();
}

class _StudentCategorySelectionScreenState
    extends State<StudentCategorySelectionScreen> {
